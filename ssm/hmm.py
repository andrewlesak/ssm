...
class HMM(object):
    ...
    def __init__(self, K, D, M=0, init_state_distn=None,
        ...
        observation_classes = dict(
            ...
            input_driven_tied_spherical_gaussian_obs_const_bias_toeplitz_weights=obs.InputDrivenTiedSphericalGaussianObservations_ConstantMusToeplitzWeights,
            input_driven_tied_spherical_gaussian_obs_const_bias_symm_toeplitz_weights=obs.InputDrivenTiedSphericalGaussianObservations_ConstantMusSymmToeplitzWeights,
            ...
            dual_input_driven_tied_spherical_gaussian_obs_const_bias_symm_toeplitz_weights=obs.DualTimeSeriesInputDrivenTiedSphericalGaussianObservations_ConstantMusSymmToeplitzWeights
            )
